...
static struct odhcp6c_opt opts[] = {
	...
	{ .code = DHCPV6_OPT_NIS_SERVERS, .flags = OPT_IP6 | OPT_ARRAY | OPT_ORO, .str = "nis_servers" },
	{ .code = DHCPV6_OPT_NISP_SERVERS, .flags = OPT_IP6 | OPT_ARRAY | OPT_ORO, .str = "nisp_servers" },
	{ .code = DHCPV6_OPT_NIS_DOMAIN_NAME, .flags = OPT_DNS_STR | OPT_ORO, .str = "nis_domainname" },
	{ .code = DHCPV6_OPT_NISP_DOMAIN_NAME, .flags = OPT_DNS_STR | OPT_ORO, .str = "nisp_domainname" },
	...
	{ .code = DHCPV6_OPT_BCMCS_SERVER_D, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_BCMCS_SERVER_A, .flags = OPT_IP6 | OPT_ARRAY | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_GEOCONF_CIVIC, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_PANA_AGENT, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_NEW_POSIX_TIMEZONE, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_NEW_TZDB_TIMEZONE, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_MIP6_HNIDF, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_MIP6_VDINF, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_V6_LOST, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_CAPWAP_AC_V6, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_RELAY_ID, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_IPV6_ADDRESS_MOS, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_IPV6_FQDN_MOS, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_NTP_SERVER, .flags = OPT_U8 | OPT_ORO, .str = "ntpserver" },
	{ .code = DHCPV6_OPT_V6_ACCESS_DOMAIN, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_SIP_UA_CS_LIST, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_BOOTFILE_URL, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_BOOTFILE_PARAM, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_CLIENT_ARCH_TYPE, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_NII, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_GEOLOCATION, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_AFTR_NAME, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_ERP_LOCAL_DOMAIN_NAME, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_DNS_STR | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_MIP6_IDINF, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_MIP6_UDINF, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_MIP6_HNP, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_MIP6_HAA, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_MIP6_HAF, .flags = OPT_DNS_STR | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_RDNSS_SELECTION, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_KRB_PRINCIPAL_NAME, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_KRB_REALM_NAME, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_KRB_DEFAULT_REALM_NAME, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_KRB_KDC, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_ADDRSEL, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_ADDRSEL_TABLE, .flags = OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_V6_PCP_SERVER, .flags = OPT_IP6 | OPT_ORO, .str = NULL },
#ifdef EXT_CER_ID
	...
	{ .code = DHCPV6_OPT_DHCP4_O_DHCP6_SERVER, .flags = OPT_IP6 | OPT_ARRAY | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_4RD, .flags = OPT_INTERNAL| OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_4RD_MAP_RULE, .flags = OPT_INTERNAL| OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_4RD_NON_MAP_RULE, .flags = OPT_INTERNAL | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_DHCP_CAPTIVE_PORTAL, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_U8 | OPT_ORO, .str = NULL },
	{ .code = DHCPV6_OPT_MPL_PARAMETERS, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_ORO, .str = NULL },
	...
	{ .code = DHCPV6_OPT_S46_PRIORITY, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_MUD_URL_V6, .flags = OPT_STR | OPT_NO_PASSTHRU, .str = "mud_url_v6" },
	{ .code = DHCPV6_OPT_V6_PREFIX64, .flags = OPT_STR | OPT_NO_PASSTHRU, .str = NULL },
	...
	{ .code = DHCPV6_OPT_V6_SZTP_REDIRECT, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_S46_BIND_IPV6_PREFIX, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_IA_LL, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_LLADDR, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_SLAP_QUAD, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_V6_DOTS_RI, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_DNS_STR, .str = NULL },
	{ .code = DHCPV6_OPT_V6_DOTS_ADDRESS, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_ARRAY | OPT_IP6, .str = NULL },
	{ .code = DHCPV6_OPT_IPV6_ADDRESS_ANDSF, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_ARRAY | OPT_IP6, .str = NULL },
	{ .code = DHCPV6_OPT_V6_DNR, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_REGISTERED_DOMAIN, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU | OPT_DNS_STR, .str = NULL },
	{ .code = DHCPV6_OPT_FORWARD_DIST_MANAGER, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
	{ .code = DHCPV6_OPT_REVERSE_DIST_MANAGER, .flags = OPT_INTERNAL | OPT_NO_PASSTHRU, .str = NULL },
